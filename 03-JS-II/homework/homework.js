...
function colors(color) {
  ...
  switch (color) {
    ...
    case "red":
      ...
      break
    case "green":
      _color = "This is green";
      break
    case "orange":
        _color = "This is orange";
        break
    default:
      break;
  }
...
function esEntero(numero) {
  ...
  // Tu código:
  let numero_redondeado = Math.floor(numero);
  return numero === numero_redondeado ? true : false;
}
...
function tieneTresDigitos(numero){
  ...
  //Escribe tu código aquí
  return (numero >= 100 && numero <= 999) ? true : false;
